...
- 💞️ **期望合作:** 我渴望为**AI智能体开发**、**模型训练和推理**、**AI Agent开发及其应用**相关的开源或商业项目做出贡献。
- 📫 **商务合作:** admin@aiprogmail.com
...
| **[NewZoe AI](https://chat.newzoe.cloud/)** | AI Agent | `html`, `GPT` | [这是一个在线项目，直接点击查看](https://chat.newzoe.cloud/) |
